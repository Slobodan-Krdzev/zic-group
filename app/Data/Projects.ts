...
export const projects: Project[] = [
  {
    ...
    projectCardInfo: {
      ...
      title: "Triumph Motorcycles Macedonia – Authorized Dealer for Triumph Motorcycles in North Macedonia.",
  ...
  },
  {
    ...
    thumbnail: "/projects/triumph/triumph.jpg",
    projectCardInfo: {
      type: 'Web Development',
      title: "Click Tint is a self-adhesive smart foil, that allows us to transform a normal window into a tinted window with a click of a button.",
